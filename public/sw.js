...
// BUMP v230: consistencia total con el criterio "gastos fijos solo en días con ventas" (Iker 2026-07-08): (1) el widget Beneficio Neto por Día deja de cargar fijos en los días cerrados → su acumulado cuadra con el TOTAL de la Cuenta de Resultados y con Omnes; (2) la tarjeta Food Cost del Diario se etiqueta "comida · mes en curso" (el equilibrio es global·90d — números distintos y correctos, no descuadre); (3) la pregunta a Omnes del equilibrio fija el rango explícito de 90 días para que sus tools de platos no usen el histórico.
// BUMP v231: consistencia final (auditoria 2026-07-08): (1) pestana Balance lee ingresos/COGS del endpoint canonico pnl-breakdown (coste congelado, no recalculo con precios de hoy), resta gastos OPERATIVOS devengados por dias con ventas y su punto de equilibrio es el MISMO snapshot que Analisis/Diario; (2) los KPIs de cabecera del Diario respetan el selector de mes (antes siempre mes actual); (3) cache del food cost canonico indexada por periodo; (4) barra 'Mes en curso' del equilibrio solo si el mes cargado ES el actual, y el mini del Diario etiqueta el mes real; (5) media de food cost del menu ponderada (COGS/ingresos) en el fallback local.
const CACHE_NAME = 'mindloop-costos-v231';
