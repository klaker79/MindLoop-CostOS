...
// BUMP v218: fix carrera de carga en Análisis — si entrabas nada más loguear (datos iniciales aún cargando), la pestaña quedaba "muerta" en ceros/vacío sin repintarse nunca (había que salir y volver). Ahora: watcher one-shot repinta solo cuando llegan los datos (si la pestaña sigue activa), y los 4 stats muestran "…" mientras el fetch está en vuelo en vez de un 0 engañoso.
const CACHE_NAME = 'mindloop-costos-v218';
