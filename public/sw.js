...
// BUMP v171: visibilidad de Omnes — botón "Pregúntale a Omnes" en cada tarjeta del feed de avisos (abre el chat con la pregunta del aviso) + welcome del chat con poderes con nombre (Coach/Diagnóstico/Informe). (v170 reservado para rama fixes del búho.)
