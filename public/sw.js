...
// BUMP v270 (aviso del recuento calibrado): el aviso solo salta con diferencias absurdas (>=90% Y >=150 EUR, o >=800 EUR). Medido sobre 150 lineas reales: 27 avisan, no 96.
const CACHE_NAME = 'mindloop-costos-v273';
