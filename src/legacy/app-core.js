...
(function () {
    ...
    function getApiAuthUrl() {
        return (window.API_CONFIG?.baseUrl ?? 'https://lite-api.mindloop.cloud') + '/api/auth';
    }
    ...
    // 🔧 FIX: Lazy resolution - window.API_CONFIG se configura DESPUÉS por main.js
    function getApiBase() {
        return (window.API_CONFIG?.baseUrl ?? 'https://lite-api.mindloop.cloud') + '/api';
    }
        ...
        try {
            ...
            if (provBarrasEl) {
                try {
                    ...
                    const baseUrl = window.API_CONFIG?.baseUrl ?? 'https://lite-api.mindloop.cloud';
