...
import { initMobilePedido } from './modules/mobile/mobile-pedido.js';
import { initInstallPrompt } from './modules/mobile/mobile-install.js';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    try { initMobilePedido(); } catch (e) { console.warn('initMobilePedido', e?.message); }
    try { initInstallPrompt(); } catch (e) { console.warn('initInstallPrompt', e?.message); }
});
