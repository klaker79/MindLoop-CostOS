            ...
            <div style="background: linear-gradient(135deg, #EEF2FF 0%, #E0E7FF 100%); border: 2px solid #6366F1; border-radius: 12px; padding: 16px; margin-bottom: 8px;">
                ...
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; text-align: center;">
                    <div style="background: #DCFCE7; padding: 12px; border-radius: 8px; border: 1px solid #22C55E;">
                        ...
                        <div style="font-size: 20px; font-weight: bold; color: #059669;">${precioMin.toFixed(2)}${window.currentUser?.moneda || '€'}</div>
                    ...
                    <div style="background: #F1F5F9; padding: 12px; border-radius: 8px;">
                        ...
                        <div style="font-size: 20px; font-weight: bold; color: #475569;">${precioMedio.toFixed(2)}${window.currentUser?.moneda || '€'}</div>
                    ...
                    <div style="background: #FEF2F2; padding: 12px; border-radius: 8px; border: 1px solid #EF4444;">
                        ...
                        <div style="font-size: 20px; font-weight: bold; color: #DC2626;">${precioMax.toFixed(2)}${window.currentUser?.moneda || '€'}</div>
                ...
                <div style="margin-top: 12px; padding: 10px; background: #FEF3C7; border-radius: 8px; text-align: center;">
                    <span style="font-size: 13px; color: #92400E;">
                        💡 <strong>Ahorro potencial:</strong> ${ahorroPotencial.toFixed(2)}${window.currentUser?.moneda || '€'}/unidad comprando a ${escapeHTML(mejorProveedor.nombre)}
                    </span>
                </div>
            </div>
        `;
                ...
                <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 12px;">
                    ...
                    <div style="text-align: right;">
                        <div style="font-size: 24px; font-weight: bold; color: ${esMejorPrecio ? '#059669' : '#1E293B'}; margin-bottom: 4px;">
                            ${parseFloat(pa.precio).toFixed(2)} ${window.currentUser?.moneda || '€'}
                        </div>
                        ${badgePrincipal}
                    </div>
                </div>
