...
function renderizarCarrito() {
    ...
    `;
        document.getElementById('carrito-total').textContent = cm(0);
        return;
    }
    ...
    `;
        ...
        <tr style="border-bottom: 1px solid #e2e8f0;">
          ...
          <td style="padding: 12px; text-align: right;">${cm(item.precio)}</td>
          <td style="padding: 12px; text-align: right; font-weight: bold;">${cm(subtotal)}</td>
          <td style="padding: 12px; text-align: center;">
