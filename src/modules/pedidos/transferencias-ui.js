                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px;">
                            <div>
                                ...
                                <div style="color: #64748b; font-size: 13px; margin-top: 4px;">
                                    ...
                                    Precio unit: <strong>${parseFloat(t.precio_unitario).toFixed(2)}${window.currentUser?.moneda || '€'}</strong> &middot;
                                    Total: <strong>${(parseFloat(t.cantidad) * parseFloat(t.precio_unitario)).toFixed(2)}${window.currentUser?.moneda || '€'}</strong>
                                </div>
