        ...
        html += `
            <tr style="background:transparent">
                ...
                <td style="width: 12%; padding: 16px; text-align: right; color: #F97316; font-weight: 700; font-size: 15px; border-bottom: 1px solid rgba(255,255,255,0.05);">
                    ${costeActual.toFixed(2)} ${window.currentUser?.moneda || '€'}
                </td>
                ...
                <td style="width: 14%; padding: 16px; text-align: right; font-weight: 700; font-size: 15px; color: ${beneficio >= 0 ? '#10B981' : '#EF4444'}; border-bottom: 1px solid rgba(255,255,255,0.05);">
                    ${beneficio >= 0 ? '+' : ''}${beneficio.toFixed(2)} ${window.currentUser?.moneda || '€'}
                </td>
    ...
    if (summary) {
        summary.innerHTML = `
            ...
            <div style="
                ...
                text-align: center;
            ">
                <div style="font-size: 28px; font-weight: 800; color: ${totalBeneficio >= 0 ? '#a78bfa' : '#EF4444'};">${totalBeneficio >= 0 ? '+' : ''}${totalBeneficio.toFixed(0)}${window.currentUser?.moneda || '€'}</div>
